 ...
 *
 * A segunda fila — os 14 da revisão de 236eba8, o "async por nome" e o
 * `__name__ == "main"` como expressão (2026-09-14) — também fechou. Esses
 * foram MOVIDOS pro grupo a que pertencem (casos_linguagem.c, bloco do
 * caminho único de chamada e do ponto de entrada; casos_crash.c, recursão que
 * passa pelo C), cada um com as variantes de caminho que o conserto cobre.
 */
#include "ps_teste.h"
