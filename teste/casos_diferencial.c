...
{ "dif #38",
  ...
  "", "SyntaxError: 'private nome: tipo' so vale no corpo da Entity \xe2\x80\x94 dentro de uma action escreva 'private <tipo> name = <valor>'", 2 },
{ "dif #39",
  "Class A() {\n    public reaction __init__(self, nome) {\n        private name = nome\n    }\n}\n",
  "", "SyntaxError: 'private' so vale antes de class/Entity, de action/reaction ou de '<tipo> <nome> = <valor>'", 2 },
{ "dif #40",
  "action f(n) {\n    private str x = n\n}\n",
  "", "SyntaxError: 'private str x = ...' declara campo do objeto: so vale dentro de uma action de Entity que recebe 'self'", 2 },
{ "dif #41",
  "x = 1\n// comentario velho\npost(x)\n",
...
{ "dif #154",
  "char action f() {\n    return 1\n}\n",
  "", "SyntaxError: so 'int action' e 'bool action' existem", 2 },
{ "dif #155",
  "str a = \"oi\"\nint b = \"7\"\nflo c = 1\nbool d = true\npost(a, b, c, d)\n",
...
{ "dif #291",
  ...
  "", "SyntaxError: faltou 'action' (ou 'reaction') antes de 'LoginHandler': int async action LoginHandler(...)", 2 },
{ "dif #292",
  "async f(x) {\n    return 1\n}\n",
  "", "SyntaxError: faltou 'action' (ou 'reaction') antes de 'f': async action f(...)", 2 },
{ "dif #293",
  "int f(x) {\n    return 1\n}\n",
  "", "SyntaxError: faltou 'action' (ou 'reaction') antes de 'f': int action f(...)", 2 },
{ "dif #294",
  "int x = 1\npost(x)\n",
  "1", NULL, 0 },
{ "dif #295",
