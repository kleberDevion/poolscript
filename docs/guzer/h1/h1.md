...
Elemento `h1` — Título de nível 1 — o maior e mais importante (um por tela). A fonte é a do sistema: diferencie com `height` (o backend X11 usa a fonte do sistema).
...
- `type()` devolve `"h1"` na janela nativa (X11).
