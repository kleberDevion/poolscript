...
Elemento `samp` — Saída de exemplo de um programa — o que apareceu no terminal.

> No HTML `samp` é **inline** (fica na mesma linha do texto ao redor). No guzer
...
app = guzer.UI("Demo")
app.samp().text("Erro 404: não encontrado")
```
