...
**55 no total** — a contagem sai da fonte (`vm/poolscript_vm.c`), não da memória de ninguém. Cada exemplo das páginas roda nos DOIS motores pela suíte (`tests/test_docs_exemplos.py`): doc errada quebra o teste.
